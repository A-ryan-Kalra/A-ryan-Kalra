...
|---------------------------------------------------------------------------------|-------------------|--------------------------------------------------|------------------------|
| [Banana Editor](https://github.com/A-ryan-Kalra/banana-editor)                  | Gen AI  | `NextJS, Gemini AI, RAG, SEO Optimized, Framer Motion, TailwindCSS`              | An AI-powered image editing platform that allows users to generate images using simple prompts and editing tools.|
